...
# === 4. Clean Duplicates (High-Level Cleaning) ===
...
female_count = len(df_clean[df_clean['gender_norm'] == 'female'])
...
# === 7. TA Breakdown (Youth, Adults, PWD) ===
youth = df_clean[df_clean['Age Group'] == 'Youth (18–35)']
adult = df_clean[df_clean['Age Group'] == 'Adult (36+)']
pwd = df_clean[df_clean['PWD Status'] == 'Yes']

# Youth by gender
youth_female = len(youth[youth['gender_norm'] == 'female'])
youth_male = len(youth[youth['gender_norm'] == 'male'])

# Adult by gender
adult_female = len(adult[adult['gender_norm'] == 'female'])
adult_male = len(adult[adult['gender_norm'] == 'male'])

# PWD breakdown
pwd_young_female = len(pwd[(pwd['Age Group'] == 'Youth (18–35)') & (pwd['gender_norm'] == 'female')])
pwd_young_male = len(pwd[(pwd['Age Group'] == 'Youth (18–35)') & (pwd['gender_norm'] == 'male')])
pwd_adult_female = len(pwd[(pwd['Age Group'] == 'Adult (36+)') & (pwd['gender_norm'] == 'female')])
pwd_adult_male = len(pwd[(pwd['Age Group'] == 'Adult (36+)') & (pwd['gender_norm'] == 'male')])
...
st.bar_chart(data=df_clean['gender_norm'].value_counts())
